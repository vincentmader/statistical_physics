...
\newcommand{\mean}[1]{\langle #1 \rangle} % partial derivative
...
\begin{document}
    ...
    \section{Weiss mean field theory for 
        the Ising model
        \textit{(3 points)}
    }
    \input{task01.tex}
    ...
    \section{Bethe mean field theory for the 
        Ising model
        \textit{(8 points)}
    }
    \input{task02.tex}
    ...
    \section{Computer exercise: Ising model
